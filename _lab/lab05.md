...
num: lab05
ready: true
desc: "Odds and primes: Arrays and makefiles"
...
```
git remote add starter git@github.com:{{site.github_org}}/STARTER-lab05.git
```
...
* Use `git commit -m "code for lab05"` to make a commit with all of these files
